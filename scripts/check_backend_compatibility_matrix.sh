...
require_file docs/backend_failure_mode_matrix.md
...
require_file tests/integration/test_backend_failure_mode_matrix.sh
...
require_file scripts/check_backend_failure_mode_matrix.sh
...
# Documentation must explicitly distinguish compatibility policy, failure evidence, and real execution status.
...
require_contains docs/backend_compatibility_matrix.md 'Finalized backend failure-mode matrix'
require_contains docs/backend_compatibility_matrix.md 'shorthand.backend_failure_mode_matrix.v1'
...
# Shared live matrix, finalized failure matrix, backend claim-safety, and hardware routing proofs.
...
bash scripts/check_backend_failure_mode_matrix.sh
