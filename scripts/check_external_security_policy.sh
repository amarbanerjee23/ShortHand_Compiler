...
require_ci 'cmake --build build-codeql --parallel 2 --target short_hand shorthand_runtime green_ai_tool shorthand_c3eco_measure shorthand_c3eco_assess shorthand_c3eco_audit'
