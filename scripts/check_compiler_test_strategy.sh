...
for mapping in \
  ...
  $'TST014\treproducible builds\timplemented' \
  $'TST015\truntime ABI compatibility\timplemented' \
  $'TST016\tpackaging and installed consumers\timplemented' \
  $'TST017\tsigned protected release\tpartial' \
  $'TST018\tdependency security and license policy\timplemented' \
  $'TST019\tcontainer and Kubernetes deployment\timplemented' \
  ...
  $'TST030\tfunctions structured control flow and deterministic errors\timplemented' \
  $'TST031\tenterprise language packages core library and FFI\timplemented' \
  $'TST032\tconcurrent serving and operational runtime\timplemented' \
  $'TST033\ttyped C3-ECO certification profile\timplemented' \
  $'TST034\tinstrumented energy carbon and cost accounting\timplemented' \
  $'TST035\tC3-ECO eligibility scoring claims and eco-regression\timplemented'; do
