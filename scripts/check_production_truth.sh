...
PILOT_RC_CONTRACT="${ROOT_DIR}/docs/enterprise_pilot_release_candidate.md"
...
for file in "${PILOT_RC_CONTRACT}" "${PILOT_RC_SCOPE}" "${PILOT_RC_SCHEMA}" "${PILOT_RC_GATE}" "${PILOT_RC_TEST}"; do
  require_file "${file}"
done
...
expected_truth=(
  ...
  'c3eco_auditor_status=signed_candidate_evidence_with_assessment_replay'
