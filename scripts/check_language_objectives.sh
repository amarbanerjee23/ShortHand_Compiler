...
require_contains 'Enterprise composite/ownership schemas, cryptographic offline packages, core library and safe FFI: PR86.'
require_contains 'Concurrent serving and operational runtime: PR87.'
require_contains 'Typed C3-ECO profile and deterministic migration: PR88.'
require_contains 'Instrument-backed C3-ECO measurement and accounting: PR89.'
require_contains 'C3-ECO eligibility, scoring, claims and eco-regression assessment: PR90.'
