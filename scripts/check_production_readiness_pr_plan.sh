...
require_file "${PLAN}"
require_contains "${PLAN}" 'production_readiness_plan_version: 2026-07-25-pr51-r2'
...
require_contains "${PLAN}" 'remaining_planned_prs_including_this_file: 28'
require_contains "${PLAN}" 'remaining_planned_prs_after_this_file: 27'
