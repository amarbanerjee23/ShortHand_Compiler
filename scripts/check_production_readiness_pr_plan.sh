...
require_file "${PLAN}"
require_contains "${PLAN}" 'production_readiness_plan_version: 2026-07-28-pr56'
require_contains "${PLAN}" 'PLAN_STATUS: active'
require_contains "${PLAN}" 'LAST_COMPLETED_PR: 56'
...
require_contains "${PLAN}" 'Next recommended PR after PR #56:'
...
require_contains "${PLAN}" 'remaining_planned_prs_after_pr56: 23'
