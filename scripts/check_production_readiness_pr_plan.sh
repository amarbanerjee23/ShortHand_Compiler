...
require_file "${PLAN}"
require_contains "${PLAN}" 'production_readiness_plan_version: 2026-07-25-pr52'
require_contains "${PLAN}" 'PLAN_STATUS: active'
require_contains "${PLAN}" 'LAST_COMPLETED_PR: 52'
...
require_contains "${PLAN}" 'Next recommended PR after PR #52:'
...
require_contains "${PLAN}" 'docs/backend_live_sdk_matrix.md'
require_contains "${PLAN}" 'PR53 - TensorRT optional live execution fixture'
...
require_contains "${PLAN}" 'remaining_planned_prs_after_pr52: 26'
