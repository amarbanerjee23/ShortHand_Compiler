...
require_contains docs/production_readiness_pr_plan.md 'production_readiness_plan_version: 2026-07-28-pr55'
require_contains docs/production_readiness_pr_plan.md 'LAST_COMPLETED_PR: 55'
require_contains docs/production_readiness_pr_plan.md 'Desired outcome definition'
require_contains docs/production_readiness_pr_plan.md 'Hardware routing expansion applied in PR #55'
...
require_contains docs/production_readiness_pr_plan.md 'PR56 - Hardware capability discovery and accelerator-aware routing'
require_contains docs/production_readiness_pr_plan.md 'remaining_planned_prs_after_pr55: 24'
