...
Required tools are a C++17 compiler, `make`, `g++`, Flex, Bison, the Flex runtime development library (`libfl-dev` on Ubuntu), LLVM with `llvm-config`, `llc`, `clang`, `clang-format`, CMake, and Ninja for validation.
