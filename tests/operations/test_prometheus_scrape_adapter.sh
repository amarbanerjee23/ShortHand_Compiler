...
cmake --build "${BUILD_DIR}" --parallel 2 --target \
  ...
  shorthand_c3eco_measure shorthand_c3eco_lifecycle_boundary shorthand_c3eco_assess shorthand_c3eco_audit shorthand_ai_qualify shorthand_prometheus_adapter
