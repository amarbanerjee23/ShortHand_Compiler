...
case "$MODE" in
  unit) run_green ;;
  compiler) run_compiler_smoke ;;
  sanitize) run_compiler_smoke; run_parser_robustness ;;
  all) run_compiler_smoke; run_parser_robustness ;;
  llvm) run_compiler_smoke; run_codegen ;;
  negative) run_negative; run_parser_robustness ;;
  ai) run_ai ;;
  ai_app) run_ai_app ;;
  *) run_green; run_compiler_smoke; run_codegen; run_negative; run_parser_robustness; run_ai ;;
esac
