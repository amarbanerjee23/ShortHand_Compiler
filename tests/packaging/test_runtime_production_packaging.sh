...
require_installed '*/share/shorthand/schemas/ai_application_config_v1.schema.json'
require_installed '*/share/shorthand/docs/ai_application_qualification.md'
require_installed '*/share/shorthand/schemas/ai_comparison_policy_v1.schema.json'
require_installed '*/share/shorthand/docs/ai_comparison_measurement.md'
...
if "${AUDIT_CLI}" >"${WORK_DIR}/audit-usage.out" 2>&1; then
  echo "error: installed auditor CLI accepted missing arguments" >&2
  exit 1
fi
grep -Fq 'usage: shorthand_c3eco_audit' "${WORK_DIR}/audit-usage.out"
