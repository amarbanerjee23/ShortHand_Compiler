...
int IR_Generator::visit(AST_FUNCTION_RULE *function) {
	...
	FunctionType *ftype = FunctionType::get(llvm::Type::getInt32PtrTy(ShortGlobalContext, 0),Integers, false);
...
int IR_Generator::visit(AST_FUNCTION_CALL_RULE *function_called) {
	 vector<Type *> argTypes;
	    ...
	    FunctionType *FType = FunctionType::get(Type::getInt32PtrTy(ShortGlobalContext,0), argsRef, false);
