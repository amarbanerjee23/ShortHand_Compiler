...
int AST_PROGRAM::accept(Visitor & v) { return v.visit(this); }
void AST_PROGRAM::setProgramName(char * progName){ this->program_name = progName; }

void AST_DATA_DECLARATION_BLOCK::push_back(string name)
{
    single_ints.push_back(name);
    AST_TYPED_SCALAR_DECLARATION typed;
    typed.name = name;
    typed_scalars.push_back(typed);
}
void AST_DATA_DECLARATION_BLOCK::push_back(string name, int size)
{
    array_ints.push_back(make_pair(name, size));
    AST_TYPED_ARRAY_DECLARATION typed;
    typed.name = name;
    typed.size = size;
    typed_arrays.push_back(typed);
}
void AST_DATA_DECLARATION_BLOCK::push_back(AST_DATA_DECLARATION_BLOCK * decl_block)
{
    ...
    typed_scalars.insert(typed_scalars.end(), decl_block->typed_scalars.begin(), decl_block->typed_scalars.end());
    typed_arrays.insert(typed_arrays.end(), decl_block->typed_arrays.begin(), decl_block->typed_arrays.end());
}
void AST_DATA_DECLARATION_BLOCK::setType(ShortType type)
{
    for (auto &entry : typed_scalars) entry.type = type;
    for (auto &entry : typed_arrays) entry.type = type;
}
int AST_DATA_DECLARATION_BLOCK::accept(Visitor & v) { return v.visit(this); }

void AST_FUNCTION_LIST_RULE::push_back(AST_FUNCTION_RULE * function) { functions.push_back(function); }
int AST_FUNCTION_LIST_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_FUNCTION_RULE::accept(Visitor & v) { return v.visit(this); }

AST_LOGIC_BLOCK::AST_LOGIC_BLOCK(AST_STATEMENTS_BLOCK * block_statement) { this->block_statement = block_statement; }
int AST_LOGIC_BLOCK::accept(Visitor & v) { return v.visit(this); }

AST_EXPRESSION_STATEMENT_RULE::AST_EXPRESSION_STATEMENT_RULE(AST_EXPRESSION_RULE * expression) { this->expression = expression; }
int AST_EXPRESSION_STATEMENT_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_FUNCTION_CALL_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_ASSIGNMENT_RULE::accept(Visitor & v) { return v.visit(this); }

void AST_STATEMENTS_BLOCK::push_back(AST_STATEMENT_RULE * statement) { statements.push_back(statement); }
int AST_STATEMENTS_BLOCK::accept(Visitor & v) { return v.visit(this); }
...
int AST_IF_STATEMENT::accept(Visitor & v) { return v.visit(this); }
...
int AST_IF_ELSE_STATEMENT::accept(Visitor & v) { return v.visit(this); }
...
int AST_FOR_LOOP_STATEMENT_RULE::accept(Visitor & v) { return v.visit(this); }
int AST_BREAK::accept(Visitor & v) { return v.visit(this); }
...
int AST_WHILE_LOOP_STATEMENT_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_GOTO_STATEMENT_RULE::accept(Visitor & v) { return v.visit(this); }

void AST_READ_RULE::push_back(AST_VARIABLE_RULE * variable) { variables.push_back(variable); }
int AST_READ_RULE::accept(Visitor & v) { return v.visit(this); }

void AST_PRINT_RULE::push_back(AST_STRING_LITERAL * string_literal)
{
    AST_PRINTABLE_ITEM x{};
...
int AST_PRINT_RULE::accept(Visitor & v) { return v.visit(this); }

AST_LABEL_RULE::AST_LABEL_RULE(string label) { this->label = label; }
int AST_LABEL_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_GREENAI_REPORT_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_AI_INFER_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_BINARY_EXPRESSION_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_UNARY_EXPRESSION_RULE::accept(Visitor & v) { return v.visit(this); }
...
int AST_SIMPLE_VARIABLE::accept(Visitor & v) { return v.visit(this); }
...
int AST_ARRAY_VARIABLE::accept(Visitor & v) { return v.visit(this); }

AST_LITERAL::AST_LITERAL(int int_literal) { this->int_literal = int_literal; }
int AST_LITERAL::accept(Visitor & v) { return v.visit(this); }

AST_STRING_LITERAL::AST_STRING_LITERAL(string string_literal) { this->string_literal = string_literal; }
int AST_STRING_LITERAL::accept(Visitor & v) { return v.visit(this); }
